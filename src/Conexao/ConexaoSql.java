...
public class ConexaoSql {
    ...
    private String database = "PANIZIO TRANSPORTES";
     ...
     */
    public ConexaoSql ( String host, String database, String user, String pass ) {
        this.pass = pass;
        this.user = user;
        this.host = host;
    ...
    public boolean connect() {
        ...
        try {
            ...
            this.con = DriverManager.getConnection(url,userName, passName);
            isConnected = true;
