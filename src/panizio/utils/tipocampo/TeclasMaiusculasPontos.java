 ...
 * 
 * Transforma qualquer letra em maiuscula e aceita pontos finais.
 */
 ...
 */
public class TeclasMaiusculasPontos extends PlainDocument{
    private int tamanhoMax;
    
    public TeclasMaiusculasPontos(int limite){
       super();
       this.tamanhoMax = limite;
    }
    
    public TeclasMaiusculasPontos() {
        super();
    ...
    public void insertString(int i, String str, AttributeSet as) throws BadLocationException {
        if (str == null) return;
         ...
         if (newString.length() > tamanhoMax) {
             ...
             super.insertString(i, str.toUpperCase().replaceAll("([^(a-zA-Z) | \\.])",""), as); 
         }         
    }
