...
//    }
     ...
     * 
     * @param List<JTextField> - campos a serem setados com
     * formatação padrão.
     */
    public static void formatarCamposDefault(List<JTextField> campos){
       for(JTextField txt : campos) txt.setDocument(new DefaultStyledDocument());    
    }
    ...
    public static void formatarCampoNumerico(JTextField txt, int tamanho) {
     ...
     /**
     * Defini que o campo somente permitirá teclas númericas 
     * e as vírgulas.
     * @param JTextField - campo a ser formatado.
     * @param int - quantidade de teclas permitidas.
     */
